...
var BreezeFilter, DesaturationFilter, Filter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
BreezeFilter = (function(_super) {
  ...
  BreezeFilter.prototype.apply = (new DesaturationFilter(BreezeFilter.app, {
    desaturation: 0.5
  })).compose(ToneCurveFilter, {
...
var CelsiusFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
var ChestFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
var FixieFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
var Filter, SaturationFilter,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

Filter = require("../filter.coffee");

SaturationFilter = (function(_super) {
  __extends(SaturationFilter, _super);

  function SaturationFilter(app, options) {
    this.app = app;
    if (options == null) {
      options = {};
    }
    SaturationFilter.__super__.constructor.apply(this, arguments);
    if (options.saturation != null) {
      this.setSaturation(options.saturation);
    }
  }

  SaturationFilter.prototype.setSaturation = function(saturation) {
    return this.saturation = typeof saturation === 'number' ? saturation + 1 : 1;
  };

  SaturationFilter.prototype.apply = function(imageData) {
    var h, index, luminance, w, x, y, _i, _j;
    w = imageData.width;
    h = imageData.height;
    for (x = _i = 0; 0 <= w ? _i < w : _i > w; x = 0 <= w ? ++_i : --_i) {
...
var ContrastFilter, Filter, FoodFilter, SaturationFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
FoodFilter = (function(_super) {
  ...
  FoodFilter.prototype.apply = (new SaturationFilter(FoodFilter.app, {
    saturation: 0.35
...
var FridgeFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
var FrontFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
var ContrastFilter, Filter, GlamFilter, GrayscaleFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
GlamFilter = (function(_super) {
  ...
  GlamFilter.prototype.apply = (new GrayscaleFilter).compose(ContrastFilter, {
    contrast: 0.1
  }).compose(ToneCurveFilter, {
...
GobblinFilter = (function(_super) {
  ...
  GobblinFilter.prototype.apply = function(imageData) {
    var h, index, w, x, y, _i, _j;
    w = imageData.width;
    h = imageData.height;
    for (x = _i = 0; 0 <= w ? _i < w : _i > w; x = 0 <= w ? ++_i : --_i) {
...
var GobblinFilter, GobblinFilterBase, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

GobblinFilterBase = require("./primitives/gobblin_filter.coffee");
...
var Filter, K1Filter, SaturationFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
K1Filter = (function(_super) {
  ...
  K1Filter.prototype.apply = (new ToneCurveFilter(K1Filter.app, {
...
var Filter, SoftColorOverlayFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

Filter = require("../filter.coffee");

SoftColorOverlayFilter = (function(_super) {
  __extends(SoftColorOverlayFilter, _super);

  function SoftColorOverlayFilter() {
    _ref = SoftColorOverlayFilter.__super__.constructor.apply(this, arguments);
    return _ref;
  }

  SoftColorOverlayFilter.prototype.apply = function(imageData) {
    var h, index, w, x, y, _i, _j;
    w = imageData.width;
    h = imageData.height;
    for (x = _i = 0; 0 <= w ? _i < w : _i > w; x = 0 <= w ? ++_i : --_i) {
...
var Filter, K2Filter, SoftColorOverlayFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
SoftColorOverlayFilter = require("./primitives/soft_color_overlay_filter.coffee");
...
var Filter, KDynamicFilter, SaturationFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
KDynamicFilter = (function(_super) {
  ...
  KDynamicFilter.prototype.apply = (new ToneCurveFilter(KDynamicFilter.app, {
...
var DesaturationFilter, Filter, LeninFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
LeninFilter = (function(_super) {
  ...
  LeninFilter.prototype.apply = (new DesaturationFilter(LeninFilter.app, {
    desaturation: 0.4
  })).compose(ToneCurveFilter, {
...
var LomoFilter, ToneCurveFilter, controlPoints, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
var MellowFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
GlowFilter = (function(_super) {
  ...
  GlowFilter.prototype.apply = function(imageData) {
  ...
  GlowFilter.prototype.setColorToAdd = function(r, g, b) {
...
var Filter, GlowFilter, MorningFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

Filter = require("./filter.coffee");

GlowFilter = require("./primitives/glow_filter.coffee");
...
MorningFilter = (function(_super) {
  ...
  MorningFilter.prototype.apply = (new ToneCurveFilter(MorningFilter.app, {
...
var DesaturationFilter, Filter, OrchidFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
OrchidFilter = (function(_super) {
  ...
  OrchidFilter.prototype.apply = (new ToneCurveFilter(OrchidFilter.app, {
...
var ContrastFilter, Filter, Pola669Filter, SaturationFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
Pola669Filter = (function(_super) {
  ...
  Pola669Filter.prototype.apply = (new ToneCurveFilter(Pola669Filter.app, {
...
var Filter, GlowFilter, SemiRedFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
SemiRedFilter = (function(_super) {
  ...
  SemiRedFilter.prototype.apply = (new ToneCurveFilter(SemiRedFilter.app, {
...
var Filter, SunnyFilter, ToneCurveFilter, contrastPoints, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
SunnyFilter = (function(_super) {
  ...
  SunnyFilter.prototype.apply = (new ToneCurveFilter(SunnyFilter.app, {
...
var TexasFilter, ToneCurveFilter, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
X400Filter = (function(_super) {
  ...
  X400Filter.prototype.apply = function(imageData) {
...
var A15Filter, BWFilter, BWHardFilter, BreezeFilter, CelsiusFilter, ChestFilter, DefaultFilter, FiltersControl, FixieFilter, FoodFilter, FridgeFilter, FrontFilter, GlamFilter, GobblinFilter, K1Filter, K2Filter, K6Filter, KDynamicFilter, LeninFilter, ListControl, LomoFilter, MellowFilter, MorningFilter, OrchidFilter, Pola669Filter, PolaFilter, QuoziFilter, SemiRedFilter, SunnyFilter, TexasFilter, Utils, X400Filter,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
A15Filter = require("../../operations/filters/a15_filter.coffee");

BWFilter = require("../../operations/filters/bw_filter.coffee");

BWHardFilter = require("../../operations/filters/bw_hard_filter.coffee");

BreezeFilter = require("../../operations/filters/breeze_filter.coffee");

CelsiusFilter = require("../../operations/filters/celsius_filter.coffee");

ChestFilter = require("../../operations/filters/chest_filter.coffee");

DefaultFilter = require("../../operations/filters/default_filter.coffee");

FixieFilter = require("../../operations/filters/fixie_filter.coffee");

FoodFilter = require("../../operations/filters/food_filter.coffee");

FridgeFilter = require("../../operations/filters/fridge_filter.coffee");

FrontFilter = require("../../operations/filters/front_filter.coffee");

GlamFilter = require("../../operations/filters/glam_filter.coffee");

GobblinFilter = require("../../operations/filters/gobblin_filter.coffee");

K1Filter = require("../../operations/filters/k1_filter.coffee");

K2Filter = require("../../operations/filters/k2_filter.coffee");

K6Filter = require("../../operations/filters/k6_filter.coffee");

KDynamicFilter = require("../../operations/filters/kdynamic_filter.coffee");

LeninFilter = require("../../operations/filters/lenin_filter.coffee");

LomoFilter = require("../../operations/filters/lomo_filter.coffee");

MellowFilter = require("../../operations/filters/mellow_filter.coffee");

MorningFilter = require("../../operations/filters/morning_filter.coffee");

OrchidFilter = require("../../operations/filters/orchid_filter.coffee");

Pola669Filter = require("../../operations/filters/pola669_filter.coffee");

PolaFilter = require("../../operations/filters/pola_filter.coffee");

QuoziFilter = require("../../operations/filters/quozi_filter.coffee");

SemiRedFilter = require("../../operations/filters/semi_red_filter.coffee");

SunnyFilter = require("../../operations/filters/sunny_filter.coffee");

TexasFilter = require("../../operations/filters/texas_filter.coffee");

X400Filter = require("../../operations/filters/x400_filter.coffee");

FiltersControl = (function(_super) {
  __extends(FiltersControl, _super);
  ...
  */
  ...
  function FiltersControl(app, ui, controls) {
    this.app = app;
    this.ui = ui;
    this.controls = controls;
    FiltersControl.__super__.constructor.apply(this, arguments);
    this.listItems = [
      {
        name: "Default",
        cssClass: "default",
        ...
        operation: K1Filter,
        tooltip: "K1",
        pixmap: "filters/k1.png"
      }, {
        name: "K2",
        cssClass: "k2",
        operation: K2Filter,
        tooltip: "K2",
        pixmap: "filters/k2.png"
      }, {
        name: "K6",
        cssClass: "k6",
        operation: K6Filter,
        tooltip: "K6",
        pixmap: "filters/k6.png"
      }, {
        name: "KDynamic",
        cssClass: "kdynamic",
        operation: KDynamicFilter,
        tooltip: "KDynamic",
        pixmap: "filters/kdynamic.png"
      }, {
        name: "Fridge",
        cssClass: "fridge",
        operation: FridgeFilter,
        tooltip: "Fridge",
        pixmap: "filters/fridge.png"
      }, {
        name: "Breeze",
        cssClass: "breeze",
        operation: BreezeFilter,
        tooltip: "Breeze",
        pixmap: "filters/breeze.png"
      }, {
        name: "Orchid",
        cssClass: "orchid",
        operation: OrchidFilter,
        tooltip: "Orchid",
        pixmap: "filters/orchid.png"
      }, {
        name: "Chest",
        cssClass: "chest",
        operation: ChestFilter,
        tooltip: "Chest",
        pixmap: "filters/chest.png"
      }, {
        name: "Front",
        cssClass: "front",
        operation: FrontFilter,
        tooltip: "Front",
        pixmap: "filters/front.png"
      }, {
        name: "Fixie",
        cssClass: "fixie",
        operation: FixieFilter,
        tooltip: "Fixie",
        pixmap: "filters/fixie.png"
      }, {
        name: "X400",
        cssClass: "x400",
        operation: X400Filter,
        tooltip: "X400",
        pixmap: "filters/x400.png"
      }, {
        name: "BW",
        cssClass: "bw",
        operation: BWFilter,
        tooltip: "BW",
        pixmap: "filters/b-w.png"
      }, {
        name: "BWHard",
        cssClass: "bwhard",
        operation: BWHardFilter,
        tooltip: "BW Hard",
        pixmap: "filters/1920.png"
      }, {
        name: "Lenin",
        cssClass: "lenin",
        operation: LeninFilter,
        tooltip: "Lenin",
        pixmap: "filters/lenin.png"
      }, {
        name: "Quozi",
        cssClass: "quozi",
        operation: QuoziFilter,
        tooltip: "Quozi",
        pixmap: "filters/quozi.png"
      }, {
        name: "Pola669",
        cssClass: "pola669",
        operation: Pola669Filter,
        tooltip: "Pola 669",
        pixmap: "filters/pola-669.png"
      }, {
        name: "Pola",
        cssClass: "pola",
        operation: PolaFilter,
        tooltip: "Pola",
        pixmap: "filters/pola.png"
      }, {
        name: "Food",
        cssClass: "food",
        operation: FoodFilter,
        tooltip: "Food",
        pixmap: "filters/food.png"
      }, {
        name: "Glam",
        cssClass: "glam",
        operation: GlamFilter,
        tooltip: "Glam",
        pixmap: "filters/glam.png"
      }, {
        name: "Celsius",
        cssClass: "celsius",
        operation: CelsiusFilter,
        tooltip: "Celsius",
        pixmap: "filters/celsius.png"
      }, {
        name: "Texas",
        cssClass: "texas",
        operation: TexasFilter,
        tooltip: "Texas",
        pixmap: "filters/texas.png"
      }, {
        name: "Morning",
        cssClass: "morning",
        operation: MorningFilter,
        tooltip: "Morning",
        pixmap: "filters/morning.png"
      }, {
        name: "Lomo",
        cssClass: "lomo",
        operation: LomoFilter,
        tooltip: "Lomo",
        pixmap: "filters/lomo.png"
      }, {
        name: "Gobblin",
        cssClass: "gobblin",
        operation: GobblinFilter,
        tooltip: "Gobblin",
        pixmap: "filters/gobblin.png"
      }, {
        name: "Mellow",
        cssClass: "mellow",
        operation: MellowFilter,
        tooltip: "Mellow",
        pixmap: "filters/mellow.png"
      }, {
        name: "Sunny",
        cssClass: "sunny",
        operation: SunnyFilter,
        tooltip: "Sunny",
        pixmap: "filters/sunny.png"
      }, {
        name: "A15",
        cssClass: "a15",
        operation: A15Filter,
        tooltip: "A15",
        pixmap: "filters/15.png"
      }, {
        name: "SemiRed",
        cssClass: "semired",
        operation: SemiRedFilter,
        tooltip: "Semired",
        pixmap: "filters/semired.png"
      }
    ];
  }
...
var FocusControl, ListControl, Utils, Vector2, linearOperation, radialOperation,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
radialOperation = require("../../operations/focus/radial_focus.coffee");

linearOperation = require("../../operations/focus/linear_focus.coffee");

FocusControl = (function(_super) {
  ...
  */
  ...
  function FocusControl(app, ui, controls) {
    this.app = app;
    this.ui = ui;
    this.controls = controls;
    FocusControl.__super__.constructor.apply(this, arguments);
    this.listItems = [
      {
        name: "Radial",
        cssClass: "radial",
  ...
  */
  ...
  FocusControl.prototype.updateOptions = function(operationOptions) {
    this.operationOptions = operationOptions;
  ...
  */
  ...
  FocusControl.prototype.onOptionsUpdated = function() {
  ...
  */
  ...
  FocusControl.prototype.hasCanvasControls = true;

  FocusControl.prototype.setupCanvasControls = function(canvasControlsContainer) {
    var height, width;
    this.canvasControlsContainer = canvasControlsContainer;
  ...
  */
  ...
  FocusControl.prototype.handleOptionSelect = function(option, item) {
    FocusControl.__super__.handleOptionSelect.apply(this, arguments);
  ...
  */
  ...
  FocusControl.prototype.setControlsMode = function(mode) {
    var i, knob, _i;
  ...
  */
  ...
  FocusControl.prototype.repositionControls = function() {
  ...
  */
  ...
  FocusControl.prototype.handleCrosshairControl = function() {
    var canvasSize,
      _this = this;
  ...
  */
  ...
  FocusControl.prototype.handleKnobControl = function() {
  ...
  */
  ...
  FocusControl.prototype.rerenderCanvas = function() {
  ...
  */
  ...
  FocusControl.prototype.drawRadialControl = function() {
  ...
  */
  ...
  FramesOperation.prototype.apply = function(imageData) {
    ...
    return Queue.promise(function(resolve, reject) {
      ...
      return frameImage.src = _this.app.buildAssetsPath(_this.options.frame);
...
var FramesControl, FramesOperation, ListControl, Rect, Utils, Vector2,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
FramesOperation = require("../../operations/frames_operation.coffee");

FramesControl = (function(_super) {
  __extends(FramesControl, _super);
  ...
  */
  ...
  function FramesControl(app, ui, controls) {
    this.app = app;
    this.ui = ui;
    this.controls = controls;
    FramesControl.__super__.constructor.apply(this, arguments);
    this.listItems = [
      {
        name: "Black",
        cssClass: "frame-black",
        operation: FramesOperation,
        options: {
          frame: "frames/black.png",
          scale: 0.1
        },
        pixmap: "frames/black-preview.png",
        tooltip: "Black",
        "default": true
      }, {
        name: "Black Wood",
        ...
        operation: FramesOperation,
        options: {
          frame: "frames/blackwood.png",
          scale: 0.1
        },
        frame: "frames/blackwood.png",
        pixmap: "frames/blackwood-preview.png",
        tooltip: "Black wood"
      }, {
        name: "Dia",
        cssClass: "frame-dia",
        operation: FramesOperation,
        options: {
          frame: "frames/dia.png",
          scale: 0.1
        },
        pixmap: "frames/dia-preview.png",
        tooltip: "Dia"
      }
    ];
  }
...
var ListControl, OrientationControl, OrientationOperation,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

ListControl = require("./base/list_control.coffee");

OrientationOperation = require("../../operations/orientation_operation.coffee");

OrientationControl = (function(_super) {
  __extends(OrientationControl, _super);
  ...
  */
  ...
  function OrientationControl(app, ui, controls) {
    this.app = app;
    this.ui = ui;
    this.controls = controls;
    OrientationControl.__super__.constructor.apply(this, arguments);
    this.listItems = [
      {
        name: "Rotate L",
        cssClass: "rotate-l",
...
var SaturationControl, SliderControl, _ref,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

SliderControl = require("./base/slider_control.coffee");

SaturationControl = (function(_super) {
  __extends(SaturationControl, _super);

  function SaturationControl() {
    _ref = SaturationControl.__super__.constructor.apply(this, arguments);
    return _ref;
  }

  SaturationControl.prototype.name = "Saturation";

  SaturationControl.prototype.cssClass = "saturation";

  SaturationControl.prototype.valueSetMethod = "setSaturation";
...
module.exports = DrawImageOperation = (function(_super) {
  ...
  function DrawImageOperation(app, options) {
    ...
    (_base = this.options).resizeButtonOffset || (_base.resizeButtonOffset = 20);
    (_base1 = this.options).scale || (_base1.scale = this.options.resizeButtonOffset + 100);
    (_base2 = this.options).stickerImageWidth || (_base2.stickerImageWidth = 100);
    (_base3 = this.options).stickerImageHeight || (_base3.stickerImageHeight = 100);
    (_base4 = this.options).widthRange || (_base4.widthRange = 570);
    (_base5 = this.options).heightRange || (_base5.heightRange = 427);
  }
...
var DrawImageOperation, ListControl, Rect, StickersControl, Vector2,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
DrawImageOperation = require("../../operations/draw_image_operation.coffee");

StickersControl = (function(_super) {
  __extends(StickersControl, _super);

  StickersControl.prototype.hasCanvasControls = true;
  ...
  */
  ...
  function StickersControl(app, ui, controls) {
    this.app = app;
    this.ui = ui;
    this.controls = controls;
    StickersControl.__super__.constructor.apply(this, arguments);
    this.listItems = [
      {
        name: "Nerd glasses",
        ...
        options: {
          sticker: "stickers/sticker-glasses-normal.png"
        },
        operation: DrawImageOperation,
        ...
        options: {
          sticker: "stickers/sticker-glasses-shutter-green.png"
        },
        operation: DrawImageOperation,
        ...
        options: {
          sticker: "stickers/sticker-glasses-shutter-yellow.png"
        },
        operation: DrawImageOperation,
        ...
        options: {
          sticker: "stickers/sticker-glasses-sun.png"
        },
        operation: DrawImageOperation,
        ...
        options: {
          sticker: "stickers/sticker-hat-cap.png"
        },
        operation: DrawImageOperation,
        ...
        options: {
          sticker: "stickers/sticker-hat-party.png"
        },
        operation: DrawImageOperation,
        ...
        options: {
          sticker: "stickers/sticker-hat-sheriff.png"
        },
        operation: DrawImageOperation,
        ...
        options: {
          sticker: "stickers/sticker-hat-cylinder.png"
        },
        operation: DrawImageOperation,
        ...
        options: {
          sticker: "stickers/sticker-heart.png"
        },
        operation: DrawImageOperation,
        ...
        options: {
          sticker: "stickers/sticker-mustache1.png"
        },
        operation: DrawImageOperation,
        ...
        options: {
          sticker: "stickers/sticker-mustache2.png"
        },
        operation: DrawImageOperation,
        ...
        options: {
          sticker: "stickers/sticker-mustache3.png"
        },
        operation: DrawImageOperation,
        ...
        options: {
          sticker: "stickers/sticker-mustache-long.png"
        },
        operation: DrawImageOperation,
        ...
        options: {
          sticker: "stickers/sticker-pipe.png"
        },
        operation: DrawImageOperation,
        ...
        options: {
          sticker: "stickers/sticker-snowflake.png"
        },
        operation: DrawImageOperation,
        ...
        options: {
          sticker: "stickers/sticker-star.png"
        },
        operation: DrawImageOperation,
  ...
  */
  ...
  StickersControl.prototype.setupCanvasControls = function(canvasControlsContainer) {
    this.canvasControlsContainer = canvasControlsContainer;
  ...
  */
  ...
  StickersControl.prototype.handleCrosshair = function() {
  ...
  */
  ...
  StickersControl.prototype.handleResizeKnob = function() {
...
var ListControl, Rect, TextControl, TextOperation, Vector2,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
TextOperation = require("../../operations/text_operation.coffee");

TextControl = (function(_super) {
  __extends(TextControl, _super);

  TextControl.prototype.singleOperation = true;

  TextControl.prototype.hasCanvasControls = true;

  TextControl.prototype.cssClassIdentifier = "text";
  ...
  */
  ...
  function TextControl(app, ui, controls) {
    ...
    TextControl.__super__.constructor.apply(this, arguments);
    this.fontResizePerClick = 3;
    this.operationClass = require("../../operations/text_operation.coffee");
    this.listItems = [
      {
        name: "Helvetica",
        method: "setFont",
  ...
  */
  ...
  TextControl.prototype.createList = function() {
    var defaultBackgroundColor, defaultForegroundColor,
      _this = this;
    TextControl.__super__.createList.apply(this, arguments);
    /*
      Color control
    */
    ...
    */
    ...
    return this.backgroundColorPreview.css({
  ...
  */
  ...
  TextControl.prototype.setupCanvasControls = function(canvasControlsContainer) {
    ...
    this.textContainer.css({
      backgroundColor: this.backgroundColorPreview.css("backgroundColor")
    });
  ...
  */
  ...
  TextControl.prototype.onFontsizeBiggerClick = function(e) {
  ...
  */
  ...
  TextControl.prototype.onFontsizeSmallerClick = function(e) {
    var canvasHeight, newFontSize, resizeFactor;
    canvasHeight = this.canvasControlsContainer.height();
    resizeFactor = this.fontResizePerClick / canvasHeight;
  ...
  */
  ...
  TextControl.prototype.updateCanvasControls = function() {
    var canvasHeight, canvasWidth;
    canvasWidth = this.canvasControlsContainer.width();
    canvasHeight = this.canvasControlsContainer.height();
    this.textContainer.css({
  ...
  */
  ...
  TextControl.prototype.handleCrosshair = function() {
    var canvasRect, maxContainerPosition, minContainerPosition, minimumHeight, minimumWidth,
      _this = this;
    canvasRect = new Rect(0, 0, this.canvasControlsContainer.width(), this.canvasControlsContainer.height());
    minimumWidth = 50;
  ...
  */
  ...
  TextControl.prototype.autoResizeTextInput = function() {
  ...
  */
  ...
  TextControl.prototype.updateOptions = function(operationOptions) {
    var canvasHeight;
    this.operationOptions = operationOptions;
    canvasHeight = this.canvasControlsContainer.height();
...
var BrightnessFilter, BrightnessOperation, Filter,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

Filter = require("./filters/filter.coffee");

BrightnessFilter = require("./filters/primitives/brightness_filter.coffee");
...
var ContrastFilter, ContrastOperation, Filter,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

Filter = require("./filters/filter.coffee");

ContrastFilter = require("./filters/primitives/contrast_filter.coffee");
...
ContrastOperation = (function(_super) {
  ...
  */
  ...
  function ContrastOperation(app, options) {
    ...
    this.filter = new ContrastFilter(this.app, {
...
var Filter, SaturationFilter, SaturationOperation,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

Filter = require("./filters/filter.coffee");

SaturationFilter = require("./filters/primitives/saturation_filter.coffee");
...
SaturationOperation = (function(_super) {
  ...
  */
  ...
  function SaturationOperation(app, options) {
    ...
    this.filter = new SaturationFilter(this.app, {
...
var BrightnessControl, BrightnessOperation, ContrastControl, ContrastOperation, CropControl, CropOperation, FiltersControl, FocusControl, FramesControl, FramesOperation, ListControl, MainMenuControl, OrientationControl, SaturationControl, SaturationOperation, StickersControl, TextControl, TextOperation,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

ListControl = require("./base/list_control.coffee");

BrightnessControl = require("./brightness_control.coffee");

ContrastControl = require("./contrast_control.coffee");

CropControl = require("./crop_control.coffee");

FiltersControl = require("./filters_control.coffee");

FocusControl = require("./focus_control.coffee");

FramesControl = require("./frames_control.coffee");

OrientationControl = require("./orientation_control.coffee");

SaturationControl = require("./saturation_control.coffee");

StickersControl = require("./stickers_control.coffee");

TextControl = require("./text_control.coffee");

BrightnessOperation = require("../../operations/brightness_operation.coffee");

ContrastOperation = require("../../operations/contrast_operation.coffee");

CropOperation = require("../../operations/crop_operation.coffee");

FramesOperation = require("../../operations/frames_operation.coffee");

SaturationOperation = require("../../operations/saturation_operation.coffee");

TextOperation = require("../../operations/text_operation.coffee");

MainMenuControl = (function(_super) {
  __extends(MainMenuControl, _super);
    ...
    this.listItems = [
      {
        ...
        name: "Stickers",
        cssClass: "stickers",
        controls: StickersControl,
        tooltip: "Stickers"
      }, {
        name: "Orientation",
        cssClass: "orientation",
        controls: OrientationControl,
        tooltip: "Orientation"
      }, {
        name: "Focus",
        cssClass: "focus",
        ...
        name: "Brightness",
        cssClass: "brightness",
        controls: BrightnessControl,
        operation: BrightnessOperation,
        tooltip: "Brightness"
      }, {
        name: "Contrast",
        cssClass: "contrast",
        controls: ContrastControl,
        operation: ContrastOperation,
        tooltip: "Contrast"
      }, {
        name: "Saturation",
        cssClass: "saturation",
        controls: SaturationControl,
